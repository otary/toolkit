package cn.chenzw.toolkit.spring.websocket;
...
public final class WebSocketKit {
    ...
    private static final String[] CLIENT_IP_HEADER_NAMES = new String[] {
            "x-forwarded-for",
            "Proxy-Client-realAddress",
            "WL-Proxy-Client-realAddress"
    };
    ...
    public static final InetSocketAddress getRemoteAddress(Session session) throws FieldNotExistException, IllegalAccessException {
        ...
        // for Tomcat 8.5+
        Object nestedFieldValue = ReflectKit.getNestedFieldValue(remote, "base#socketWrapper#socket#sc#remoteAddress");
