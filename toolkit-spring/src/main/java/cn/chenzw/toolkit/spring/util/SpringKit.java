...
import cn.chenzw.toolkit.spring.entity.ContextBeans;
import cn.chenzw.toolkit.spring.entity.ContextFilterMappings;
import cn.chenzw.toolkit.spring.entity.ContextHandlerMappings;
import cn.chenzw.toolkit.spring.entity.ContextServletMappings;
...
public final class SpringKit {
     ...
     * 是否Spring环境
     */
    public static final boolean SPRING_FRAME_PRESENT = ClassKit.isPresent("org.springframework.context.ApplicationContext");

    /**
     * 是否SpringWeb环境
     */
    public static final boolean SPRING_WEB_FRAME_PRESENT = ClassKit.isPresent("org.springframework.web.servlet.DispatcherServlet");
    ...
    public static ContextHandlerMappings getHandlerMappings() {
        ...
        Map<String, HandlerMapping> handlerMappings = appContext.getBeansOfType(HandlerMapping.class);
        for (Map.Entry<String, HandlerMapping> handlerMappingEntity : handlerMappings.entrySet()) {
            ...
            if (handlerMapping instanceof RequestMappingHandlerMapping) {
                ...
                log.info("BeanNameUrlHandlerMapping: {}", handlerMap);
                ...
                for (Map.Entry<String, ?> urlMappingEntry : urlMap.entrySet()) {
                    if (urlMappingEntry.getValue() instanceof ResourceHttpRequestHandler) {
                        ...
                        log.info("Extended HttpRequestHandler: {}", urlMappingEntry);
                    }
                }
            } else {
                log.info("Extended HandlerMapping: {}", handlerMapping);
            }
        }
