...
public class RandomStringKitTests {

    @Test
    public void testRandomFrequentlyUsedChinese() {
        for (int i = 0; i < 3; i++) {
            String chineseCharacters = RandomStringKit.randomFrequentlyUsedChinese(5);
    ...
    public void testRandomFrequentlyUsedChinese2() {
        for (int i = 0; i < 3; i++) {
            String chineseCharacters = RandomStringKit.randomFrequentlyUsedChinese(3, 5);
    ...
    public void testRandomChinese() {
        for (int i = 0; i < 3; i++) {
            String chineseCharacters = RandomStringKit.randomChinese(5);
            Assert.assertEquals(5, chineseCharacters.length());
    ...
    public void testRandomChinese2() {
        for (int i = 0; i < 3; i++) {
            String chineseCharacters = RandomStringKit.randomChinese(3, 5);
            Assert.assertTrue(chineseCharacters.length() >= 3 && chineseCharacters.length() < 5);
    ...
    public void testRandomName() {
        for (int i = 0; i < 3; i++) {
            String name = RandomStringKit.randomName();
    ...
    public void testRandomFromList() {
        ...
        for (int i = 0; i < 3; i++) {
            String name = RandomStringKit.randomFromList("张三", "李四", "王五", "赵六");
