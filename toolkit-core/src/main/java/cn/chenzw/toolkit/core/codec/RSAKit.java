...
public final class RSAKit {
    ...
    /**
     * 将私钥字符串转换成PrivateKey对象{@link PrivateKey}对象
     *
     * @param privateKey
    ...
    /**
     * 将PEM格式字符串转换成PrivateKey对象{@link PrivateKey}对象
     *
     * @param privateKey
     * @return {@link PrivateKey}对象
     * @throws NoSuchAlgorithmException
    ...
    /**
     * 将公钥字符串转换成PublicKey{@link PublicKey}对象
     *
     * @param publicKey
    ...
    /**
     * 将PEM格式字符串转换成PublicKey对象{@link PublicKey}对象
     *
     * @param publicKey
     * @return {@link PublicKey}对象
     * @throws NoSuchAlgorithmException
    ...
    public static final String parseAsPEM(PublicKey publicKey) {
        return parseAsPublicKeyPEM(publicKey.getEncoded());
    }
     ...
     * @return
     */
    public static final String parseAsPublicKeyPEM(byte[] keyBytes) {
